...
| T5 | 增强文件工作台 | 现有 `/files` 页面 | `src/components/views/file-workspace.tsx`、`src/app/globals.css` | 分类概览可筛选 | Done |
| T6 | 登记新增资产 | 工作台数据模块 | `src/lib/data/workflow-data.ts` | 新资产可检索，指标同步 | Done |
